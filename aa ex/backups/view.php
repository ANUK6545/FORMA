...
?>
 ...
 <?php 
  ...
  $num = mysqli_num_rows($showques);
   ...
   ?>
   <input type="text" id="<?php echo $arrques['question_id'] ?>">
...
$(document).ready(function(){
      ...
      var html = '<tr><td><input class="form-control"  type="text" name="questions[]" required></td><td><input class="btn btn-danger" type="button" value="remove" name="remove" id="remove" ></td></tr>';
