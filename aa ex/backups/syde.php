...
<div id="mySidenav" class="sidenav">
 ...
 <div class="menuu" id="dash"><a href="homepg.php">Dashboard</a></div>
  ...
  <div class="dropdown-container">
    ...
    <div class="sub-menuu"><a href="user_list.php">Users list</a></div>
  ...
  <div class="dropdown-container">
    <div class="sub-menuu"><a href="c1_survey.php">Create Survey </a></div>
    <div class="sub-menuu"><a href="survey_list.php">Survey List</a></div>
    <!-- <div class="sub-menuu"><a href="response.php">Results of Survey</a></div> -->
  </div>

  <div class="menuu" id="logout"><a href="homepg.php">Logout</a></div>
</div>
