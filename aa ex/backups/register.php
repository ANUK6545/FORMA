...
<html lang="en">
    ...
    <style>
        body{
            background-color: rgba(9, 2, 29, 0.884);
        }
        .card:hover {
                ...
                <div id="login-row" class="row justify-content-center align-items-center">
                    <div id="login-column" class="col-md-6">
                        <div id="login-box" class="col-md-12">
                            ...
                            <h3 class="text-center text-info" style="padding:30px;">Register here!</h3>
                     ...
                     <input type="submit" name="submit" class="btn btn-info btn-md" value="SIGN UP" style="width:45%; margin-left:30%"> 
                            </div>
