...
if(isset($_POST['submit'])){
    ...
    foreach ($fullnm as $key => $value){
        $save = "INSERT INTO `pop`(`id`,`full`,`question`) VALUES ('".$value."','".$fullnm[$key]."','$qtxt') ";
...
<script>
    ...
    $(document).ready(function(){
        ...
        // let btncount = document.querySelector('#submit');
...
<table class="table table-stripped">
        ...
        <?php
         $select = "SELECT * FROM `pop` order by id desc";
                                ...
                                <div class="container">
                                    <form class="insert-form" id="insert-form" method="POST" action="">
                                        ...
                                        <div class="input-field">
                                            ...
                                            <input type="submit" value="Add" name="submit" class="submit" id="submit">
                                        </div>
                                    </form>
