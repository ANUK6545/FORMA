...
$shower = "SELECT * FROM `answer` WHERE  `survey_id` = '" . $ids . "' ";
...
$dis = "SELECT DISTINCT question , answer
FROM question
...
<div class="row">
    ...
    <label >Survey Name:<?php echo $arrdata['survey_name']; ?> </label>
    <label >Survey description:<?php echo $arrdata['survey_desc']; ?> </label>
    </div>
 ...
 <!-- <?php   while ($arrques = mysqli_fetch_array($showques)) {
  ...
  echo $arrdis['question'];?>
  <br>
  <?php echo $arrdis['answer']; ?>
  <br> <br>
   <?php } ?>
